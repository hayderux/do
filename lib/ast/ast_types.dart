...
class CompoundNode extends ASTNode {
  ...
  ASTNode copy() {
    ...
    for (var child in compoundValue) {
...
class FuncCallNode extends ASTNode {
  ...
  ASTNode copy() {
    ...
    for (var child in functionCallArgs) {
...
class FuncDefNode extends ASTNode {
  ...
  ASTNode copy() {
    ...
    for (var child in functionDefArgs) {
      node.functionDefArgs.add(child?.copy());
    }

    for (var child in compChildren) {
...
class ClassNode extends ASTNode {
  ...
  ASTNode copy() {
    ...
    for (var child in classChildren) {
...
class EnumNode extends ASTNode {
  ...
  String toString() {
    ...
    String enumStr = 'enum {\n';
    for (var element in enumElements) {
      enumStr += ' ${element.toString()},\n';
    }
    enumStr += '}';
...
class ListNode extends ASTNode {
  ...
  ASTNode copy() {
    ...
    for (var child in funcDefinitions) {
...
class VariableNode extends ASTNode {
  ...
  ASTNode copy() {
    ...
    for (var element in classChildren) {
      node.classChildren.add(element?.copy());
    }
    for (var element in enumElements) {
      node.enumElements.add(element?.copy());
    }
...
class StrBufferNode extends ASTNode {
  ...
  @override
  ASTNode copy() {
    final StrBufferNode node = StrBufferNode()
      ..scope = scope
      ..strBuffer = strBuffer;
...
class BinaryOpNode extends ASTNode {
  ...
  String toString() {
    ...
    ASTNode visitedBiOp;
    Runtime(null).visitBinaryOp(this).then((value) => visitedBiOp = value);
...
class UnaryOpNode extends ASTNode {
  ...
  String toString() {
    ...
    Runtime(null)
        .visitUnaryOp(this)
        .then((value) => visitedUnaryOp = value);
...
class ReturnNode extends ASTNode {
  ...
  @override
  ASTNode copy() {
    final ReturnNode node = ReturnNode()
      ..scope = scope
...
class ThrowNode extends ASTNode {
  ...
  @override
  ASTNode copy() {
    final ThrowNode node = ThrowNode()
      ..scope = scope
      ..throwValue = (throwValue?.copy());
