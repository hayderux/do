...
ASTNode visitListProperties(ASTNode node, ASTNode left) {
  ...
  switch (binaryOpRight.variableName) {
    ...
    case 'reversed':
      return ListNode()
        ..listElements = left.listElements.reversed.toList();
...
ASTNode visitListMethods(ASTNode node, ASTNode left) {
  ...
  switch (binaryOpRight.funcCallExpression.variableName) {
    ...
    case 'appendAll':
      ...
      return left
        ..listElements
            .addAll(binaryOpRight.functionCallArgs[0].listElements);
    ...
    case 'appendAt':
      ...
      left.listElements = elements.getRange(0, args[0].intVal).followedBy([
        args[1],
        ...elements.getRange(args[0].intVal, elements.length)
      ]).toList();
    ...
    case 'at':
      ...
      return left.listElements
          .elementAt(binaryOpRight.functionCallArgs[0].intVal);
    ...
    case 'atRange':
      ...
      return ListNode()
        ..listElements = left.listElements
            .getRange(args[0].intVal, args[1].intVal)
            .toList();
    ...
    case 'fillRange':
      ...
      return left
        ..listElements.fillRange(args[0].intVal, args[1].intVal, args[2]);
    ...
    case 'removeAll':
      ...
      for (int i = 0;
          i < binaryOpRight.functionCallArgs[0].listElements.length;
          i++) {
    ...
    case 'with':
      ...
      return ListNode()
        ..listElements = left.listElements
            .followedBy(binaryOpRight.functionCallArgs[0].listElements);

    default:
      throw NoSuchMethodException(
          binaryOpRight.funcCallExpression.variableName, 'List');
  }
}
