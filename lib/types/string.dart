...
ASTNode visitStringMethods(ASTNode node, ASTNode left) {
  ...
  switch (binaryOpRight.funcCallExpression.variableName) {
    ...
    case 'padLeft':
      expectArgs(binaryOpRight.functionCallArgs, [IntNode, StringNode]);
      final List<ASTNode> args = binaryOpRight.functionCallArgs;
    ...
    case 'replaceAll':
      expectArgs(binaryOpRight.functionCallArgs, [StringNode, StringNode]);
    ...
    case 'replaceFirst':
      ...
      return left
        ..stringValue = left.stringValue.replaceFirst(
            args[0].stringValue, args[1].stringValue, args[2].intVal);

    case 'replaceRange':
      expectArgs(
          binaryOpRight.functionCallArgs, [IntNode, IntNode, StringNode]);

      final List<ASTNode> args = binaryOpRight.functionCallArgs;

      return left
        ..stringValue.replaceRange(
            args[0].intVal, args[1].intVal, args[2].stringValue);

    case 'split':
      expectArgs(binaryOpRight.functionCallArgs, [StringNode]);

      return ListNode()
        ..listElements = left.stringValue
    ...
    default:
      throw NoSuchMethodException(
          binaryOpRight.funcCallExpression.variableName, 'String');
  }
}
